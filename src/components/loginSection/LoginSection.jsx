        ...
        <div className='flex gap-[100px] 2xl:gap-[80px] max-1200px:gap-[50px] max-1098px:flex-col max-1098px:flex-col-reverse'>
            ...
            <div className='bg-white p-[50px] 2xl:p-[40px] mob-scr:p-[30px] flex flex-col gap-[50px] 2xl:gap-[40px] mob-scr:gap-[30px]'>
                <div className='text-center'>
                    <h1 className='font-semibold text-5xl 2xl:text-[38px] mob-scr:text-[28px] leading-normal'>Login</h1>
                    <p className='font-normal text-lg text:darkHash 2xl:text-base mob-scr:text-sm'>Welcome back! Please log in to access your account.</p>
                </div>
                <div>
                    <div className='flex flex-col gap-[24px]'>
                        ...
                        <div className='flex items-center gap-[10px]'>
                            ...
                            <p className='font-normal text-lg 2xl:text-base mob-scr:text-sm text-hash-1 '>Remember Me</p>
                        </div>
                        <div>
                            <button className='login w-full flex items-center justify-center gap-8 p-2 px-4 text-lg 2xl:text-sm mob-scr:text-xs text-white'>Login</button>
                        </div>
                    </div>
                    <div className='mt-[24px] flex flex-col gap-[30px] 2xl:gap-[24px]'>
                        ...
                        <div className='flex gap-[10px] justify-center py-[20px] px-[24px] 2xl:[py-16px] bg-white-97 rounded-4 '>
                            ...
                            <p className='font-medium text-lg 2xl:text-base '>Login with Google</p>
                        </div>
                        <div className='flex gap-[10px] justify-center '>
                            <span className='font-normal text-base mob-scr:text-sm'>Don’t have an account?<b>Sign Up</b></span>
